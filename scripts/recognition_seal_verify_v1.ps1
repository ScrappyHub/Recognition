...
# Promoted from scripts\_scratch\RUN_RECOGNITION_RUNTIME_BRIDGE_SEAL_VERIFY_V1.ps1 (identical logic).
# Production scripts must not depend on _scratch; locked startup v2 uses this copy.
...
function RunCapture {
  ...
  $RunDir = Join-Path $RepoRoot "proofs\runs\recognition_seal_verify_v1"
