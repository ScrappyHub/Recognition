# Ecosystem Integration — Recognition
...
| Canonical name | Recognition |
| Ecosystem layer | `foundation.identity-profile` |
| Standalone-first | `true` |

## Role

Identity-bound encrypted profile and governed recognition instrument.
...
- Locked startup
- Profile receipts
- Governed profile access

## This service does not own

- Primary identity issuance
